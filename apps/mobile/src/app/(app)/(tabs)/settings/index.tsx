...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#f9fafb', borderRadius: 12, overflow: 'hidden' },
  profileHeader: { flexDirection: 'row', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#e5e7eb' },
  avatar: { width: 56, height: 56, borderRadius: 28, backgroundColor: '#FF0000', justifyContent: 'center', alignItems: 'center', marginRight: 16 },
  ...
  detailValue: { fontSize: 15, fontWeight: '500', color: '#111' },
  ...
  menuLabel: { flex: 1, fontSize: 15, color: '#111' },
  menuValue: { fontSize: 15, color: '#6b7280' },
  menuArrow: { fontSize: 16, color: '#9ca3af' },
  logoutButton: { backgroundColor: '#fef2f2', borderRadius: 12, padding: 16, alignItems: 'center' },
